...
const client_sql=`CREATE TABLE IF NOT EXISTS client (
    ...
    vaccine_1_date DATE NULL DEFAULT NULL,
    vaccine_1_manufacturer VARCHAR(45) NULL,
    vaccine_2_date DATE NULL DEFAULT NULL,
    vaccine_2_manufacturer VARCHAR(45) NULL,
    vaccine_3_date DATE NULL DEFAULT NULL,
    vaccine_3_manufacturer VARCHAR(45) NULL,
    vaccine_4_date DATE NULL DEFAULT NULL,
    vaccine_4_manufacturer VARCHAR(45) NULL,
    positive_date DATE NULL,
    recovery_date DATE NULL,
    client_img LONGTEXT NULL,
    PRIMARY KEY (id));`;
/*const address_sql=`CREATE TABLE IF NOT EXISTS address (
    id INT NOT NULL AUTO_INCREMENT,
    city VARCHAR(45) NULL,
    street VARCHAR(45) NULL,
    building INT NULL,  
    PRIMARY KEY (id));`;*/
const vaccine_sql=`CREATE TABLE IF NOT EXISTS vaccine (
    id INT NOT NULL AUTO_INCREMENT,
...
const sql_init=()=>{
    ...
    //dal_mysql.execute(address_sql);
    dal_mysql.execute(vaccine_sql);
